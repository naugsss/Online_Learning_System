...
class Mentor(Courses):
    ...
    def add_mentor(self):
        ...
        result = DatabaseConnection.insert_into_db(get_query["GET_FROM_AUTHENTICATION"], (user_name,))
        DatabaseConnection.update_db(get_query["UPDATE_INTO_USER_ROLES"], (3, result[0][3]))
